            ...
            <table className="w-full" style={{ borderCollapse: 'collapse', fontSize: 12 }}>
              <thead style={{ position: 'sticky', top: 0, zIndex: 1, background: 'var(--bg)' }}>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <th className="text-left px-5 py-2 font-medium" style={{ color: 'var(--text-muted)', width: 240 }}>
                    Aa Nom
                  </th>
                  <th className="text-left px-3 py-2 font-medium" style={{ color: 'var(--text-muted)', width: 64 }}>
                    Date
                  </th>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                ...
                {selectedEntry.summary && (
                  <PropRow icon="≡" label="En bref">
                    <span style={{ lineHeight: 1.5 }}>{selectedEntry.summary}</span>
                  </PropRow>
                )}
                {selectedEntry.createdTime && (
                  <PropRow icon="🕐" label="Créé le">
                    {formatFullDate(selectedEntry.createdTime)}
                  </PropRow>
                )}
              </div>
            </div>
