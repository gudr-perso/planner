...
export type ViewKey = 'home' | 'calendar' | 'rolling' | 'rolling2' | 'gantt' | 'settings' | 'briefing' | 'todo' | 'partenaires' | 'suivis' | 'temps' | 'tickets' | 'postits' | 'users' | 'clients' | 'projets' | 'projet-detail' | 'ged';
...
export function Toolbar({
  ...
  const isNonPlanningView = view === 'home' || view === 'briefing' || view === 'settings' || view === 'partenaires' || view === 'suivis' || view === 'tickets' || view === 'temps' || view === 'postits' || view === 'users' || view === 'todo' || view === 'clients' || view === 'projets' || view === 'projet-detail' || view === 'ged';
